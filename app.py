...
from ui.components import (
    ...
    pipeline_indicator_html,
    report_footer_html,
    report_section_header_html,
    report_sticky_nav_html,
)
...
st.markdown(
    report_sticky_nav_html(PIPELINE_STAGES),
    unsafe_allow_html=True,
)
